...
public class Initializer implements ServletContextListener {
    ...
    public void contextInitialized(ServletContextEvent sce) {
        ...
        productDataStore.add(new Product("Spinner - Mepps Aglia TW with fish silver", 1700, "HUF", "", baits, mepps, "https://www.fishernator.com/media/catalog/product/cache/8/thumbnail/1500x1500/9df78eab33525d08d6e5fb8d27136e95/5/2/52-71004_p_web.jpg"));
